...
const HomePage = () => {
  ...
  const { jwt, id: loggedInUserId, username, accountType } = user;
                  ...
                  <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                    <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                      ...
                      <div className="mx-5">
                        ...
                        <div className="text-gray-500">My Customers</div>
                      </div>
                    </div>
                  </div>
                  <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                ...
                <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                  <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div className="mx-5">
                      ...
                      <div className="text-gray-500">My Subscriptions</div>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                  ...
                  <div className="mx-5">
                    ...
                    <div className="text-gray-500">Support Tickets</div>
                  </div>
                </div>
              </div>
            </div>
